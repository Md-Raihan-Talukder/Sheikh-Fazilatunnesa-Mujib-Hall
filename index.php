  ...
  <div class="slider-provost-message">
    <div class="row">
      ...
      <div class="col-md-4 provost-message-area">
        <h2>Message From Provosts</h2>
        <div>
          <img src="images/provost/sir_3.jpg" class="img img-fluid provost-img">
        </div>
        <div>
         Sheikh Fazilatunnesa Mujib Hall of Patuakhali Science And Technology University is a safest hall for minority students, Hindu, Buddhist, Christian, and others. This is a big hall for women including meeting rooms, dining rooms, a prayer hall, gardens, and sporting facilities. There are approximately 1000 students in the hall. All students get all facilities in this hall. 
        </div>
        <div>
        </div>
      </div
      ...
      <div class="row mt-3 mb-5">
        ...
        <div class="col-md-3">
          <div class="card single-link" onclick="location.href='http://cse.pstu.ac.bd/welcome/news_details/2'">
            ...
            <div class="card-body">
              <h4 class="card-title">PSTU Bosonto Boron</h4>
            </div>
          </div>
        </div>
		...
		<div class="col-md-3">
          <div class="card single-link" onclick="location.href='http://cse.pstu.ac.bd/welcome/news_details/5'">
            ...
            <div class="card-body">
              <h4 class="card-title">PSTU IT Carnival</h4>
            </div>
          </div>
        </div>
        <div class="col-md-3">
          <div class="card single-link" onclick="location.href='http://cse.pstu.ac.bd/welcome/gallery_category_details/15'">
            ...
            <div class="card-body">
              <h4 class="card-title">PSTU Rag Day</h4>
            </div>
          </div>
        </div>
